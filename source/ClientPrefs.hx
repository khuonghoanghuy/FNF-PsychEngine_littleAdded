...
class ClientPrefs {
	...
	public static var shadersToy:Bool = false;
	...
	public static var iconbeattype:String = "Psych Engine";
	...
	public static function saveSettings() {
		...
		FlxG.save.data.shadersToy = shadersToy;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.shadersToy != null) {
			shadersToy = FlxG.save.data.shadersToy;
		}
